...
define('MSG_USER_PROFILE_UPDATED', 'Your profile details have been updated');
define('MSG_USER_PROFILE_UPDATE_FAILED', 'Error occured, profile details not updated');
define('MSG_EMAIL_EXIST', 'That e-mail is already in use.');
define('MSG_USERNAME_EXIST', 'That username is already used.');
...
define('MSG_POST_EDITED','Tweet has been edited');
define('MSG_NO_CHANGES_ON_POST','The tweet has no edits');
