...
class crMessage {
    ...
    public static function composeMessage($data){
        ...
        $receivers = $data['to'];
        if(!cr_not_null($receivers)){
            cr_add_message(MSG_SENDER_EMPTY_ERROR, MSG_TYPE_ERROR);
            return false;
        }

        if(trim($data['subject']) == ''){
            cr_add_message(MSG_MESSAGE_SUBJECT_EMPTY_ERROR, MSG_TYPE_ERROR);
            return false;
        }

        if(trim($data['body']) == ''){
            cr_add_message(MSG_MESSAGE_BODY_EMPTY_ERROR, MSG_TYPE_ERROR);
            return false;
        }
        ...
        foreach($receivers as $receiver){
            ...
            $receiverInfo = crUser::getUserBasicInfo($receiver);
