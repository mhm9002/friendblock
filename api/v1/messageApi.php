...
class BuckysMessageApi {
    ...
    public function getMessageInfoAction(){
        ...
        if(empty($row)){
            return ['STATUS_CODE' => STATUS_CODE_UNAUTHORIZED, 'DATA' => cr_api_get_error_result('No record found.')];
        }
    ...
    public function deleteMessageInfoAction(){
        ...
        if(BuckysMessage::deleteMessage($data['messageID'])){
            ...
            return ['STATUS_CODE' => STATUS_CODE_UNAUTHORIZED, 'DATA' => cr_api_get_error_result('There was an error to send your message.')];
        }
    }
