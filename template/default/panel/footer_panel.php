...
if($userID = cr_is_logged_in()){
    $userBasicInfo = crUser::getUserBasicInfo($userID);
    ?>
    <div id="fixed_footer">
        <ul id="footer_menu"><!-- Begin Footer Menu -->
            ...
            <li class="rightIcons">
                ...
                <?php
                //$newMsgNum = crMessage::getNumOfNewMessages($userID);
                if($newMsgNum && $newMsgNum > 0){
                    //$newMails = crMessage::getReceivedMessages($userID, 1, 'unread');
                    ?>
    ...
    <div id="fixed_footer">
        <div class="centered-navigation">
            <ul id="footer_menu"><!-- Begin Footer Menu -->
                ...
                <!-- End Videos -->
                <li id="rightAlign">
                    <?php if($SITE_GLOBALS['content'] != 'register' && $SITE_GLOBALS['headerType'] != 'forum'){ ?>
